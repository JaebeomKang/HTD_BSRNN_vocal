...
def get_model(args):
    time_duration = int((1 - 0.01 * args.augment.repitch.max_tempo) * args.dset.samplerate * args.dset.segment)
    time_duration -= int(args.dset.samplerate * args.dset.shift)
...
def main(args):
    ...
    if args.test.get_sample:
        solver.get_sample()
    elif args.test.get_loss:
        solver.get_loss()
    else:
        solver.train()
